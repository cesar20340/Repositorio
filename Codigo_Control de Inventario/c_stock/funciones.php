...
function guardar_historial($id_producto,$user_id,$fecha,$nota,$quantity){
	global $con;
	$sql="INSERT INTO historial (id_historial, id_producto, user_id, fecha, nota, cantidad)
	VALUES (NULL, '$id_producto', '$user_id', '$fecha', '$nota',  '$quantity');";
