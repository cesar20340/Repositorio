<?php
	...
	if (isset($_POST['quantity'])){
		...
		guardar_historial($id_producto,$user_id,$fecha,$nota,$quantity);
	...
	if (isset($_POST['quantity_remove'])){
            ...
            <div class="row">
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
					...
					<div class="col-sm-12">
                      <span class="item-price">$ <?php echo $row['precio_producto'];?></span>
                    </div>
					
                    <div class="col-sm-12 margin-btm-10">
					</div>
                    <div class="col-sm-6 col-xs-6 col-md-4 ">
                      <a href="" data-toggle="modal" data-target="#add-stock"><img width="80px"  src="img/stock-in.png"></a>
                    </div>
                    <div class="col-sm-6 col-xs-6 col-md-4">
                      <a href="" data-toggle="modal" data-target="#remove-stock"><img width="80px"  src="img/stock-out.png"></a>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
                    </div>
