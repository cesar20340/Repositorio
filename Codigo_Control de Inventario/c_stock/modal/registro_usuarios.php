		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="password" class="form-control" id="user_password_new" name="user_password_new" placeholder="(minimo 6 caracteres)" pattern=".{6,}" title="Contraseña " required>
				</div>
			  </div>
			  <div class="form-group">
				<label for="user_password_repeat" class="col-sm-3 control-label">Repite contraseña</label>
				<div class="col-sm-8">
				  <input type="password" class="form-control" id="user_password_repeat" name="user_password_repeat" placeholder="(minimo 6 caracteres)" pattern=".{6,}" required>
				</div>
			  </div>
		  </div>
